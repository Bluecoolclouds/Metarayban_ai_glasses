...
// 2. App behavior with mock device paired (MainMenuScreen)
...
class InstrumentationTest {
  ...
  @Test
  fun showsMainMenuScreenWhenMockPaired() {
    val mockDeviceKit = MockDeviceKit.getInstance(targetContext)
    mockDeviceKit.pairRaybanMeta().powerOn()

    composeTestRule.waitUntilExactlyOneExists(hasText("VisionClaw"), timeoutMillis = 5000)
  }
